...
const experiences = [
  {
    ...
    desc: "Developed responsive CRM and ERP web interfaces using React, Tailwind CSS, HTML, CSS, and JavaScript (ES6+), collaborating in agile teams at Novaork Software Company to enhance usability and cross-browser compatibility.",
    logo: novaork,
    tech: [
      {
        name: "HTML5",
